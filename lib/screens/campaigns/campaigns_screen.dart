...
class _CampaignsScreenState extends State<CampaignsScreen> {
                  ...
                  onPressed: () async {
                    ...
                    final success = await campaignProvider.createCampaign(
                      CampaignModel(
                        ...
                        organizerName: auth.currentUser?.name ?? '',
  ...
  Widget build(BuildContext context) {
    final auth = context.read<AuthProvider>();
    final isAdminOrHospital = auth.currentUser?.role.name == 'admin' || auth.currentUser?.role.name == 'hospital';
        ...
        actions: [
          if (isAdminOrHospital)
            IconButton(
              ...
              onPressed: _showAddCampaignDialog, // Simple stub for now
            )
        ],
      ),
                                  ...
                                  onPressed: () async {
                                    ...
                                    if (success && context.mounted) {
                                      ...
                                      if (donorProvider.currentDonorProfile != null) {
                                        donorProvider.recordDonation(donorProvider.currentDonorProfile!.id);
                                      }
                                      ScaffoldMessenger.of(context).showSnackBar(
